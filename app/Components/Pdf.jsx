...
//require('react-pdf-js');
require('pdfjs-dist');

//import  $ from 'jquery';

const PDF_URL = 'https://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf'
//const PDF_URL = 'https://damota.me/cv.pdf'

class Pdf_c extends React.Component {
    constructor (props) {
        super(props)
        this.state = {
            pdf: null,
...
Page.contextTypes = Pdf_c.childContextTypes
...
Viewer.contextTypes = Pdf_c.childContextTypes


module.exports = {Viewer:Viewer, Pdf:Pdf_c};
